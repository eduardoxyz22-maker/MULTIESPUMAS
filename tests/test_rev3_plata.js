...
(async () => {
  ...
  /* La sección 2 (el flete en la hoja de ruta) se fue a tests/test_rev3_admin.js §1: quedó la versión que usa
     las palabras de la tarjeta del chofer (`cobroRutaTxt` con `f`), y dos versiones mostraban el flete dos veces. */
