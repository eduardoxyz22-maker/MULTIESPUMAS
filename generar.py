...
panel_data = {
    ...
    "global": {
        ...
        "prevCierres": compradores_prev,
        "cerrado": _cerrado_total_p,
        "prevCerrado": round(cerrado_prev),
        "pipeline": _pipeline_total_p,
        "prevPipeline": round(valor_prev),
        "ticket": _ticket_avg_p,
        "prevTicket": round(cerrado_prev / compradores_prev) if compradores_prev else 0,
    },
